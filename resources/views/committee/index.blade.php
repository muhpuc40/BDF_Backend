...
<div class="container">
    ...
    <a href="{{ route('committees.create') }}" class="btn btn-primary mb-3">Add New Member</a>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                @if($committee->image)
                <img src="{{ asset('storage/' . $committee->image) }}" class="card-img-top" alt="{{ $committee->name }}" style="height: 250px; object-fit: cover;">
                @else
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('committees.show', $committee) }}" class="btn btn-info btn-sm mt-2">View Details</a>
                </div>
            </div>
        </div>
        @endforeach
