        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <p><strong>From:</strong> {{ $email->name }}</p>
                            <p><strong>Email:</strong> {{ $email->email }}</p>
                        </div>
                        <div class="col-md-6">
                            <p><strong>Phone:</strong> {{ $email->phone ?? 'Not provided' }}</p>
                            <p><strong>IP Address:</strong> {{ $email->ip_address }}</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p><small class="text-muted">Received: {{ $email->created_at->format('F j, Y, g:i a') }}</small></p>
                        </div>
                        <div class="col-md-6 text-end">
                            <span class="badge bg-{{ $email->status === 'replied' ? 'success' : ($email->status === 'read' ? 'info' : 'warning') }}">
