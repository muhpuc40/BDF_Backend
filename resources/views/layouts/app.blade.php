...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <button class="btn btn-outline-light d-none d-lg-block">Logout</button>
        </div>
    </nav>
    ...
    <div class="offcanvas offcanvas-start d-lg-none" tabindex="-1" id="mobileMenu">
        ...
        <div class="offcanvas-body p-0">
            <div class="p-3">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="/committees/create">
    ...
    <script>
        // Auto-close mobile sidebar when clicking links
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (offcanvas) {
                ...
                const sidebarLinks = document.querySelectorAll('#mobileMenu .nav-link');
